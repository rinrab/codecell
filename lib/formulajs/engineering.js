...
formula.ERF = function (lower_bound, upper_bound) {
    throw new Error('ERF is not implemented');
}
...
// TODO
formula.ERF.PRECISE = function () {
    throw new Error('ERF.PRECISE is not implemented');
};

// TODO: jStat
formula.ERFC = function (x) {
    throw new Error('ERFC is not implemented');
}
//formula.ERFC = function (x) {
